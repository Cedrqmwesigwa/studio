...
const featuredProjects = [
  ...
  { title: "Luxury Apartment", image: "https://images.unsplash.com/photo-1580041065738-e72023775cdc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxsdXh1cnklMjBhcGFydG1lbnR8ZW58MHx8fHwxNzQ5NzMwNzgyfDA&ixlib=rb-4.1.0&q=80&w=1080", dataAiHint: "luxury apartment", type: "Residential", href: "/portfolio" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredProjects.map((project, index) => (
            <Card 
              ...
              style={{animationDelay: `${index * 0.1 + 0.3}s`}}
            >
              <div className="aspect-video relative overflow-hidden"> {/* Ensure parent has relative positioning and defined aspect ratio */}
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
